...
@Singleton
@Type("opuscapita")
public class OcStatisticsService extends Traceable implements StatisticsService {

    private static final Logger logger = LoggerFactory.getLogger(OcStatisticsService.class);
    ...
    @Inject
    public OcStatisticsService(RawStatisticsRepository rawStatisticsRepository,
